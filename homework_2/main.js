...
//     document.write(`
// <div>
// ${name}- ${surname}- ${age}- ${info}- <img src="${photo}" alt="simpsons">
// </div>
// `);
// }
...
//         <img src="${image}" alt="products" class="product-image">
// </div>`);
//
// }
// document.write('</div>');
...
for (const clientInfo of usersList) {
    let {id, name, username, email, phone, address: {city, street, suite, zipcode}} = clientInfo;
    document.write(`

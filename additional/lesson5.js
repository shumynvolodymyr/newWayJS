...
// const formForName = document.forms.formForName;
// const name = formForName.name;
// const submit = formForName.submit;
//
...
const formForProduct = document.forms.formForProduct;
const name = formForProduct.nameProduct;
const quantity = formForProduct.quantityProduct;
const price = formForProduct.priceProduct;
...
//         div.append(`${item}: ${user[item]}`);
//
//         //// div.innerText = `${user.name} ${user.age} ${user.status} ${JSON.stringify(user.address)}`
//     }
// }
...
//         div.append(divka);
//         divka.innerHTML = `${item}: ${JSON.stringify(user[item])}`
//     }
// }
...
//         const divka = document.createElement('div');
//         divka.append(user.address[element]);
//         divAddress.append(divka)
//     }
//
//     document.body.appendChild(div);
//     divName.append(user.name);
//     divAge.append(user.age);
//     divStatus.append(user.status);
//
//     div.append(divName);
//     div.append(divAge);
...
//     rulesDiv.append(rulesH2);
//     rulesDiv.append(rulesP);
//
//     rulesH2.append(rule.title);
//     rulesP.append(rule.body);
// }